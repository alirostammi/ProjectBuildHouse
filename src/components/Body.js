		...
		<div className="main mt-5">
			...
			<section className="container pictures mt-3">
				<div className='row'>
					...
					<div className='col-sm-3 mb-3'><img src={pic2} width={'95%'} /></div>
					<div className='col-sm-3 mb-3'><img src={pic3} width={'95%'} /></div>
					<div className='col-sm-3 mb-3'><img src={pic4} width={'95%'} /></div>
					<div className='col-sm-3'><img src={pic5} width={'95%'} height={'88%'} /></div>
					{/* </div> */}
				</div>
			</section>
				...
				<div className='row justify-content-between'>
					...
					<div className='col-md-6 collec mt-3 mt-sm-0'>
						...
						<div className='row mt-4'>
							<div className='col-sm-2 text-center'><img src={icon1} width="70%" /></div>
						...
						<div className='row mt-3'>
							<div className='col-sm-2 text-center'><img src={icon2} width="70%" /></div>
							<div className='col-sm-10'>
						...
						<div className='row mt-3'>
							<div className='col-sm-2 text-center'><img src={icon3} width="70%" /></div>
							<div className='col-sm-10'>
			...
			<section className='container-fluid my-5 section_last'>
				<div className='row align-items-center text-center'>
					<div className='col-md-6'><img src={pic7} style={{ maxWidth: '70%' }} /></div>
