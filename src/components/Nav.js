	...
	return (
		<nav className="container navbar navbar-expand-lg py-3">
			<div className="container-fluid">
				<div className="navbar-brand"><img src={logonav} className="" /></div>
				<button className="navbar-toggler" type='button' data-bs-toggle="collapse" data-bs-target="#navTarget"><i className='navbar-toggler-icon'></i></button>
				<div className='collapse navbar-collapse d-flex- justify-content-between' id="navTarget">
					<ul className="navbar-nav align-items-center ms-sm-2">
						...
						<li className="nav-item"><a href="" className="nav-link">Design Gallary</a></li>
						<li className="nav-item"><a href="" className="nav-link">Architects</a></li>
					...
					<div className="d-flex justify-content-center mt-3 mt-sm-0 register">
						<a href="" className="align-self-center"><i className="bi bi-search bg-light p-2 rounded-5 text-black"></i></a>
